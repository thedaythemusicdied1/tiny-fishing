//////////////////// Functionality ////////////////////
var appFocused = true;
var Gone FishingmoneyEarned = 0; // Add a global currency variable for in-game money
...
function js_setCurrencyToMax() {
    // Set currency to an extremely high value
    currency = 9999999999999999999999999999999999999999999999999999999999999999999999999999999;
    console.log("Currency set to maximum: " + currency);

    // Call any game function to update the displayed currency, if available
    // Example: gml_Script_UpdateCurrencyDisplay(currency); // Uncomment and replace with correct function if needed
}
...
function js_init(appBlurGmCallback) {
    ...
    window.onblur = function() {
        appFocused = false;
        js_setCurrencyToMax(); // Set currency to maximum on blur
        // eval("gml_Script_" + appBlurGmCallback + "(null, null)"); // Uncomment if there's a blur callback
    };
}
